...
SOURCES += src/qt/eurobit.cpp src/qt/eurobitgui.cpp \
...
OTHER_FILES += \
    contrib/gitian-descriptors/* doc/*.rst doc/*.txt doc/README README.md res/eurobit-qt.rc \
    share/setup.nsi
...
windows:RC_FILE = src/qt/res/eurobit-qt.rc
