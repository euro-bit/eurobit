...
#ifndef Q_WS_MAC
    qApp->setWindowIcon(QIcon(":icons/eurobit"));
...
void BitcoinGUI::createActions()
{
    ...
    toggleHideAction = new QAction(QIcon(":/icons/eurobit"), tr("Show/Hide &Eurobit"), this);
...
#ifndef Q_WS_MAC
            qApp->setWindowIcon(QIcon(":icons/eurobit_testnet"));
...
void BitcoinGUI::setMining(bool mining, int hashrate)
{
    if (mining)
    {
        ...
        labelMiningIcon->setToolTip(tr("Mining Eurobits at %1 hashes per second").arg(hashrate));
    }
    else
    {
        labelMiningIcon->setPixmap(QIcon(":/icons/mining_inactive").pixmap(STATUSBAR_ICONSIZE,STATUSBAR_ICONSIZE));
        labelMiningIcon->setToolTip(tr("Not mining Eurobits"));
    }
}
