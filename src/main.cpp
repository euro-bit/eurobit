...
uint256 hashGenesisBlock("0x6ce2748cd9e8eeaade6ebf6f233b9141056b21e4da016adfdfca6f35d1ffcd1c");
...
int64 static GetBlockValue(int nHeight, int64 nFees){
    ...
    // Subsidy is cut in half every 1051200 blocks, which will occur approximately every 4 year
    //nSubsidy >>= (nHeight / 1051200); 
    nSubsidy >>= (nHeight / 4200000);

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 60 * 60;	// Eurobit: 1 hour
static const int64 nTargetSpacing = 180;		// Eurobit: 30 sec
static const int64 nInterval = nTargetTimespan / nTargetSpacing;
static const int64 nTargetTimespanRe = 60 * 60; // 60 Minutes
static const int64 nTargetSpacingRe = 180; 		// Eurobit: 30 seconds
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "_______TCC_______";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
...
{
	return false;
	//commenting out this code until we properly implement EBI alerts.
	/*
    if (!CheckSignature())
        return false;
    if (!IsInEffect())
